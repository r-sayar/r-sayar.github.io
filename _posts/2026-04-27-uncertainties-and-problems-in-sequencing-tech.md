...
- A large & structured dataset containing most or all bulk data and/or single-cell data.
    In this it should be noted which sequencing technology has been used, all necessary metadata should be included, it should be normalized,
